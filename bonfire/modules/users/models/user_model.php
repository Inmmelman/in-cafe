...
class User_model extends BF_Model
{
    ...
    //protected $common_table_name = 'users';
    ...
    public function find_common($field = null, $value = null){
        $this->table_name = 'common_users';
        $checkResult = parent::find_by($field, $value);
